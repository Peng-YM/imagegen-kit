[Skip to content](https://zenmux.ai/docs/guide/advanced/image-generation.html#VPContent)

On this page

Copy Page

# Image Generation - Google Gemini Protocol [​](https://zenmux.ai/docs/guide/advanced/image-generation.html\#image-generation-google-gemini-protocol)
...
This guide focuses on the Google Gemini protocol. If you want to call OpenAI image models through the OpenAI Images protocol, see [OpenAI Images protocol image generation](https://zenmux.ai/docs/guide/advanced/openai-image-generation.html).
...
## Supported Models [​](https://zenmux.ai/docs/guide/advanced/image-generation.html\#supported-models)
...
## Reference Documentation [​](https://zenmux.ai/docs/guide/advanced/image-generation.html\#reference-documentation)
...
## Usage [​](https://zenmux.ai/docs/guide/advanced/image-generation.html\#usage)
...
## Non-Google Model Usage [​](https://zenmux.ai/docs/guide/advanced/image-generation.html\#non-google-model-usage)
...
### Supported Parameters [​](https://zenmux.ai/docs/guide/advanced/image-generation.html\#supported-parameters)

#### generate\_images Parameters [​](https://zenmux.ai/docs/guide/advanced/image-generation.html\#generate-images-parameters)
...
#### edit\_image Parameters [​](https://zenmux.ai/docs/guide/advanced/image-generation.html\#edit-image-parameters)
...
### Generating Images [​](https://zenmux.ai/docs/guide/advanced/image-generation.html\#generating-images)
...
### Advanced Parameter Examples [​](https://zenmux.ai/docs/guide/advanced/image-generation.html\#advanced-parameter-examples)

#### Generating High-Resolution Images [​](https://zenmux.ai/docs/guide/advanced/image-generation.html\#generating-high-resolution-images)
...
#### Generating 4K Images [​](https://zenmux.ai/docs/guide/advanced/image-generation.html\#generating-4k-images)
...
#### Specifying Output Format and Compression Quality [​](https://zenmux.ai/docs/guide/advanced/image-generation.html\#specifying-output-format-and-compression-quality)
...
### Editing Images [​](https://zenmux.ai/docs/guide/advanced/image-generation.html\#editing-images)
...
#### Editing with a Mask [​](https://zenmux.ai/docs/guide/advanced/image-generation.html\#editing-with-a-mask)
...
## Configuration [​](https://zenmux.ai/docs/guide/advanced/image-generation.html\#configuration)

### Required Parameters [​](https://zenmux.ai/docs/guide/advanced/image-generation.html\#required-parameters)
...
### Invocation Modes [​](https://zenmux.ai/docs/guide/advanced/image-generation.html\#invocation-modes)
...
## Best Practices [​](https://zenmux.ai/docs/guide/advanced/image-generation.html\#best-practices)
